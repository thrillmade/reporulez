...
- **2026-06-29** — max mode: init --local-only — /clud-bug-review slash command + commit hook (F4 rollout) *(f4-maxmode)* — [decisions-branches/f4-maxmode.md](decisions-branches/f4-maxmode.md)
- *... 6 more decisions ...*
